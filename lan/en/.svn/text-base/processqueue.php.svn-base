...
'looking for users who can be excluded from this mailing' => 'looking for subscribers who can be excluded from this processqueue run',
...
'Unconfirmed user' => 'Unconfirmed subscriber',
...
'mailtics has started sending the message with subject %s' => 'mailtics has started sending the message with subject %s',
...
'mailtics has finished sending the message with subject %s' => 'mailtics has finished sending the message with subject %s',
