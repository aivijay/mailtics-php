...
$lan = array(
  ...
  'no_users_to_copy' => 'No subscribers to copy, is the prefix correct?',
  ...
  'usertable_prefix' => 'Subscribertable prefix:',
  'select_lists' => 'Select the lists to add the emails to',
  'copy_lists' => 'Copy lists from remote server (lists are matched by name)',
  'users_as_html' => 'Mark new subscribers as HTML:',
  'info_overwrite_existing' => 'If you check "Overwrite Existing", information about a subscriber in the database will be replaced by the imported information. Users are matched by email.',
  ...
  'and' => 'and',
  'existing users' => 'existing subscribers',
  'continue' => 'Continue',
