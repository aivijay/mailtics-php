...
'User data was updated for %d users' => 'User data was updated for %d subscribers',
'%d users were matched by foreign key, %d by email' => '%d subscribers were matched by foreign key, %d by email',
'mailtics Import Results' => 'mailtics Import Results',
...
'assigninvalid_blurb' => 'Assign Invalid will be used to create an email for subscribers with an invalid email address.
...
'overwriteexisting_blurb' => 'If you check "Overwrite Existing", information about a subscriber in the database will be replaced by the imported information. Users are matched by email or foreign key.',
...
'sendnotification_blurb' => 'If you choose "send notification email" the subscribers you are adding will be sent the request for confirmation of subscription to which they will have to reply. This is recommended, because it will identify invalid emails.',
'mailtics Import  Results' => 'mailtics Import  Results',
