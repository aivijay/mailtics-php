...
/* read lines below as sentences: if you check 'overwrite' information about a user... etc. */
  ...
  "information about a user in the database will be replaced by the imported information. Users are matched by email." => "information about a subscriber in the database will be replaced by the imported information. Users are matched by email.",
  ...
  "import3info" => "There are two ways to add the names of the subscribers,
