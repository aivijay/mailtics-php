...
//  'textandhtml' => 'Text and HTML', //obsolete by bug 0009687
  ...
  'messagefooterexplanation' => 'Use <b>[UNSUBSCRIBE]</b> to insert the personal unsubscribe URL for each subscriber.
    <br/>Use <b>[PREFERENCES]</b> to insert the personal URL for a subscriber to update their details',
  ...
  'sendtestexplain' => '(comma separate addresses - all must be subscribers)',
  'criteriaexplanation' => '
  ...
  'nocriteria' => 'There are currently no attributes available to use for sending a message. The message will go to any subscriber on the lists selected',
  ...
  'excludelistexplain' => 'The message will go to subscribers who are a member of the lists above,
  ...
  'operator' => 'operator',
  'values' => 'values',
  '%d users apply' => '%d subscribers apply',
