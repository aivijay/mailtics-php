...
'mailtics has started sending the message with subject %s' => 'mailtics ha comenzado a enviar el mensaje cuyo asunto es %s',
...
'mailtics has finished sending the message with subject %s' => 'PHPList ha terminado de enviar el mensaje cuyo asunto es %s'
