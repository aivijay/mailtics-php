...
'mailtics Import Results' => 'mailtics Importeer Resultaten',
...
'automatically added' => 'automatisch toegevoegd',
 'importintro' => '<p>Het bestand dat he het geupload zal het attribuut van de verslagen op de eerste lijn nodig hebben.
    ...
    Dit zal het importatieprocess vertragen. Als je dit gebruikt, dan is het toegelaten om velden te zonder email,
    maar een "Ongeldige Email" zal in de plaats worden aangemaakt. Daarna kan u zoeken op "ongeldige email"
    om deze velden te vinden. Max lengte van een Foreign Key is 100.
    <br/><br/>
...
'mailtics Import  Results' => 'mailtics Importatie  Resultaten',
...
'Make confirmed immediately' => 'Bevestig Onmiddelijk',
'Import' => 'Importeer',
