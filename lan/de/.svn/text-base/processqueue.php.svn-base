...
'mailtics has started sending the message with subject %s' => 'Versand der Nachricht mit Betreff %s gestartet',
...
'mailtics has finished sending the message with subject %s' => 'Versand der Nachricht mit Betreff %s abgeschlossen',
