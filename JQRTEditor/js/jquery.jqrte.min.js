 ...
 */
$.jQRTE={iconList:["popup_html","popup_bgcolor","popup_forecolor","bold","italic","underline","justifyleft","justifycenter","justifyright","justifyfull","insertHorizontalRule","insertorderedlist","insertunorderedlist","indent","outdent","popup_addlink","unlink","removeformat","strikethrough","superscript","subscript","popup_addtable","popup_uploadfile","popup_addimage","popup_uploadimage","popup_emotion","popup_character","popup_copyright"],rangeObj:null,element:null,selectionObj:null,boxy:{},backcolor:"#ffffff",forecolor:"#000000",backcolorList:{},forecolorList:{},init:function(element){document.getElementById(element).contentWindow.document.designMode="on";
...
},saveRange:function(element){var iframe=document.getElementById(element);
...
if(navigator.userAgent.indexOf("Firefox")!=-1){if($.jQRTE.rangeObj){$.jQRTE.selectionObj.removeAllRanges();
$.jQRTE.selectionObj.addRange($.jQRTE.rangeObj)
}}else{if($.jQRTE.rangeObj){$.jQRTE.rangeObj.select()
...
},setContent:function(element){var rid=element.split("_");
var textid="";
for(var i=0;
i<rid.length-1;
i++){textid+="_"+rid[i]
...
if(content!=""){document.getElementById(element).contentWindow.document.open();
...
if(id=="bgcolor"&&navigator.userAgent.indexOf("MSIE")!=-1){rid="backColor"
...
if(navigator.userAgent.indexOf("MSIE")!=-1){$("#html_content").text(document.getElementById(element).contentWindow.document.body.innerHTML)
...
if(navigator.userAgent.indexOf("MSIE")!=-1){$("#"+textid).text($("#html_content").text())
}else{$("#"+textid).text($("#html_content").val())
}if(navigator.userAgent.indexOf("MSIE")!=-1){$(document.getElementById(element).contentWindow.document.body).html($("#html_content").text())
...
if(navigator.userAgent.indexOf("MSIE")!=-1){document.getElementById(element).contentWindow.document.selection.createRange().pasteHTML(html_content)
}else{var success=false;
try{document.getElementById(element).contentWindow.document.execCommand("insertHTML",false,html_content);
success=true
}catch(e){}if(!success){try{document.getElementById(element).contentWindow.document.execCommand("insertText",false,html_content)
}catch(e){}}}$.jQRTE.restoreRange(element);
var box=element.split("_");
var textid="";
for(var i=0;
i<box.length-1;
...
$(form).appendTo("body");
return form
},ajaxFileUpload:function(s){s=$.extend({},$.ajaxSettings,s);
...
$.fn.extend({jqrte:function(){return this.each(function(){$.jQRTE.init(this.id)
})
...
},jqpopup_close:function(){return this.each(function(){try{$.jQRTE.restoreRange($.jQRTE.element)
}catch(e){}$.jQpopup.close(this.id)
})
}});
function specialcharacter(){var cols=15;
var j=0;
