...
<html>
  <head>
<script type="text/javascript" src="../js/jqdock/jquery-1.2.6.min.js"></script>
  <link rel='stylesheet' type='text/css' href='../js/jqdock/shadowbox.css' />
  <script type='text/javascript' src='../js/jqdock/jquery.shadowbox.js'></script>
  <script type='text/javascript' src='../js/jquery.jqDock.min.js'></script>
  <script type='text/javascript' src='../js/jqdock/demo.js'></script>
...
<div id='menu1' class="demo">
  <a href='index.php?page=send' title=''>
    <img src='../images/campaign.png' alt='Email Campaign' title='' /></a>
  <a href='index.php?page=users' title=''>
    <img src='../images/users.png' alt='Users' title='' /></a>
  <a href='index.php?page=list' title=''>
    <img src='../images/reports.png' alt='Report' title='' /></a>
</div>


<a href="#" onClick="openMailingList('index.php?page=list'); return true;">Mailing List</a>
