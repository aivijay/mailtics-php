...
<script type="text/javascript">
  ...
  jQuery(function($) { $('#tabs_campaign').tabs({ cookie: { expires: 365 } }); }); 
...
$("#tab2").click(function() 
{ 
    var fetch_url = "?page=send&id='<?php echo $id;?>'&h=1&tab=Content&nh=1&st=1";
    alert('debug: -> fetch_url = [' + fetch_url + ']');
    $.ajax( 
    { 
        url: fetch_url, 
        cache: false, 
...
<a id="tab2" href="#">Tab 2</a><br>
<a id="tab3" href="#">Tab 3</a><br>
...
echo '
    <div id="tabs_campaign" style="width: 99%; height: 100%;">
      <ul>
        <li><a href="#tabs-1">Content</a></li>
        <li><a href="?page=send&id='. $id . '&h=1&tab=Format&nh=1&st=1">Format/Template</a></li>
        <li><a href="#tabs-3">Preview</a></li>
        <li><a href="?page=send&id='. $id . '&h=1&tab=Attach&nh=1&st=1">Attach</a></li>
        <li><a href="?page=send&id='. $id . '&h=1&tab=Lists&nh=1&st=1">Lists</a></li>
        <li><a href="#tabs-6">Segment</a></li>
        <li><a href="?page=send&id='. $id . '&h=1&tab=Scheduling&nh=1&st=1">Scheduling</a></li>
        <li><a href="?page=send&id='. $id . '&h=1&tab=Misc&nh=1&st=1">Misc</a></li>
        <?php if (ENABLE_RSS) {  ?>
        <!--<li><a href="#tabs-9">RSS</a></li>-->
        <?php } ?>
        <?php if (sizeof(' . $GLOBALS["plugins"] . ')) { ?>
        <?php } ?>
        <!--<li><a href="?page=send&id='. $id . '&h=1&tab=Test&nh=1&st=1">Test Message</a></li>-->
      </ul>
      <iframe id="tabs-1" width="97%" height="90%" src="?page=send&id='. $id . '&h=1&tab=Content&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <!--
      <iframe id="tabs-2" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Format&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      -->
      <iframe id="tabs-3" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Preview&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <!--
      <iframe id="tabs-4" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Attach&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <iframe id="tabs-5" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Scheduling&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      -->
      <iframe id="tabs-6" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Criteria&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <!--
      <iframe id="tabs-7" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Lists&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <iframe id="tabs-8" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Misc&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <iframe id="tabs-9" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=RSS&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      <iframe id="tabs-10" width="97%" height="100%" src="?page=send&id='. $id . '&h=1&tab=Test&nh=0&st=1">
        <p>Tab 1 content</p>
      </iframe> 
      -->
      ';
...
$log = fopen("/tmp/pp1.txt", "a");
fwrite($log, "debug: --> GOING FOR id = [$id]\n");
if ($id) {
  ...
  fwrite($log, "debug: --> s4 -- data [$field] = [" . $msg[$field] . "]\n");
...
#    $tabs->addTab("Review and Send","$baseurl&amp;tab=Review");
  ...
  $formatting_content = '<table class="composemesg">';
...
print "<hr><table width=\"100%\"><tr><td align=center><input type=submit name=\"save\" value=\"$savecaption\" class=\"ui-state-default ui-corner-all\"></td></tr></table>\n<hr>\n";
print "<input type=hidden name=id value=$id>\n";
print "<input type=hidden name=status value=\"".$_POST["status"]."\">\n";
print '<input type=hidden name=expand value="0">';

?>
    </div> <!-- end tabs_campaign -->
