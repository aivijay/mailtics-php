...
config.ImageBrowserURL = config.BasePath + "../?page=fckmailtics&action=browseimage" ;
...
config.ImageUploadURL = config.BasePath + "../?page=fckmailtics&action=uploadimage" ;
...
config.LinkBrowserURL = config.BasePath + "../?page=fckmailtics&action=browsefile" ;
config.LinkBrowserWindowWidth  = 400 ;
config.LinkBrowserWindowHeight  = 250 ;

config.LinkUpload = false ;
config.LinkUploadURL = config.BasePath + "../?page=fckmailtics&action=uploadfile" ;
...
// PHP
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/mailtics/connector.php'
...
// PHP
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/mailtics/connector.php' ;
...
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/upload/mailtics/upload.php?Type=Image' ;
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=' + encodeURIComponent( FCKConfig.BasePath + 'filemanager/connectors/mailtics/connector.' + _FileBrowserExtension ) ;
...
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/connectors/mailtics/upload.php?Type=Image' ;
FCKConfig.ImagePath = document.location.protocol + '//' + document.location.host +'<?php echo $GLOBALS["pageroot"].'/'.FCKIMAGES_DIR.'/'?>'
