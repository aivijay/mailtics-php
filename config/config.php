...
$message_envelope = 'babu@falcon.mydomain.com';
...
$bounce_mailbox_user = 'bounces1';
$bounce_mailbox_password = 'bounces1';
...
$bounce_mailbox = '/var/mail/bounces1';
...
# default login is "admin" with password "mailtics"
#
$require_login = 1;
...
# add spamblock
# if you set this to 1, mailtics will try to check if the subscribe attempt is a spambot trying to send
...
# notify spam
# when mailtics detects a possible spam attack, it can send you a notification about it
...
# request the "Powered By" image from www.mailtics.com, instead of locally. This will give me
...
$stats_collection_address = 'babu@falcon.mydomain.com';
...
# if this is enabled mailtics will initialise the From in new messages to be the
...
# test emails
# if you send a test email, mailtics will by default send you two emails, one in HTML format
...
# if you have modules to contribute, send them to mailtics2@tincan.co.uk
# the default module is mailtics_auth.inc, which you can find in the "auth" subdirectory of the
# admin directory. It will tell you the functions that need to be defined for mailtics to
# retrieve it's information.
# mailtics will look for a file in that directory, or you can enter the full path to the file

# eg
#$admin_auth_module = 'mailtics_auth.inc';
...
# go via mailtics. This will make sure that clicks are tracked. This is experimental and
...
# to run processqueue many times, when you use domain throttling. You can also tell mailtics
...
# set this to 1 to enable the JQRT Editor
# NOTE:  If you enable this editor, disable other editors
define("USEJQRT",0);


# Provide the directory name of to store the uploaded files using
# JQRT editor.  The directory should have the writable permission by
# the webserver, and it needs to be in your website public document area.
define("JQRTUPLOAD_DIR","uploadfiles");
...
define("PLUGIN_ROOTDIR","/home/me/mailticsplugins");
...
define('FPDF_FONTPATH','includes/fpdf16/font');
...
# PHP mail() command.
define("PHPMAILERHOST",'falcon.mydomain.com');
...
# tmpdir. A location where mailtics can write some temporary files if necessary
...
# $SessionTableName = "mailticssessions";
...
#
# New added/moved DEFS with ref to mailtics - vijay
#
define("MAX_USER_PP", 50);
define("MAX_MSG_PP", 25);

// used with dashboard related code
define("MAX_CAMPAIGNS_COUNT", 5);
define("MAX_MAILINGS_COUNT", 5);
