...
//      $html .= sprintf('<td valign="top" %s class="listingname"><span class="listingname"><a href="%s" class="listingname">%s</a></span></td>',$width,$element["url"],$element["name"]);
      $html .= sprintf('<td valign="top" %s class="thickbox"><span class="thickbox"><a href="%s" class="thickbox">%s</a></span></td>',$width,$element["url"] . "&width=90%&height=90%&h=1",$element["name"]);
    } else {
//      $html .= sprintf('<td valign="top" %s class="listingname"><span class="listingname">%s</span></td>',$width,$element["name"]);
      $html .= sprintf('<td valign="top" %s class="thickbox"><span class="thickbox">%s</span></td>',$width,$element["name"]);
    }
...
class WebblerTabs {
  ...
  function display() {
    ...
    $html .= '<table style="margin:25px; border:1px solid gray;"><tr><td>';
    $html .= '<div id="webblertabs" style="margin:0px 0px 0px 25px; border:0px solid gray; width:850px;">';
    $html .= '<ul>';
    reset($this->tabs);
