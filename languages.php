...
class mailtics_I18N {
  ...
  function formatText($text) {
    # we've decided to spell mailtics all lowercase
    $text = str_replace('PHPlist','mailtics',$text);
...
#       return 'TE'.$text.'XT';
  ...
  function missingText($text) {
    if (isset($GLOBALS["developer_email"])) {
      ...
      #sendMail($GLOBALS["developer_email"],"mailtics dev, missing text",$msg);
      $line = "'".$text."' => '".$text."',";
