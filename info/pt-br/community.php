...
if ($fp = @fopen ("http://www.mailtics.com/files/LATESTVERSION","r")) {
  ...
  if (versionCompare($thisversion,$latestversion)) {
    ...
    print '<a href="http://www.mailtics.com/files/changelog">Veja o que mudou</a>&nbsp;&nbsp;';
    print '<a href="http://www.mailtics.com/files/mailtics-'.$latestversion.'.tgz">Baixar</a>';
  }
} else {
  print "<br/>Veja se h&aacute; uma nova vers&atilde;o: <a href=http://www.mailtics.com/files>clicando aqui</a>";
}
?>
...
<ul>
<li><a href="http://www.mailtics.com/forums/" target="_blank">F&oacute;runs</a></li>
...
Por favor, publique suas opini&otilde;es nos <a href="http://www.mailtics.com/forums/" target="_blank">F&oacute;runs</a>.</p></li>
<li>
<p>Voc&ecirc; pode usar o PHPlist para seus clientes pagos (se voc&ecirc &eacute; faz parte de uma equipe de web, por exemplo) e mostre que o sistema &eacute; uma grande ferramente para atingir os seus objetivos. Ent&atilde;o, se eles quiserem algumas mudan&ccedil;as, voc&ecirc; pode <b>encomendar novas caracter&iacute;sticas</b> que s&aeo; pagas pelos seus clientes. Se voc&ecirc; quiser saber quanto custaria para incluir novas caracter&iacute;sticas &agrave;o PHPlist, <a href="mailto:mailtics@tincan.co.uk?subject=request for quote to change PHPlist">entre em contato</a>.
...
Para enviar um relat&oacute;rio de erro, acesse <a href="http://mantis.tincan.co.uk/" target="_blank">http://mantis.tincan.co.uk</a>
