...
if ($fp = @fopen ("http://www.mailtics.com/files/LATESTVERSION","r")) {
  ...
  if (versionCompare($thisversion,$latestversion)) {
    ...
    print '<a href="http://www.mailtics.com/files/changelog">Ver los cambios</a>&nbsp;&nbsp;';
    print '<a href="http://www.mailtics.com/files/mailtics-'.$latestversion.'.tgz">Descargar</a>';
  }
} else {
  print "<br/>Ver cu&aacute;l es la &uacute;ltima versi&oacute;n: <a href=http://www.mailtics.com/files>aqu&iacute;</a>";
}
?>
...
<ul>
<li>Los <a href="http://www.mailtics.com/forums/" target="_blank">Foros</a></li>
...
de sus pruebas en los <a href="http://www.mailtics.com/forums/" target="_blank">Foros</a>.</p></li>
<li>
...
quiere saber cu&aacute;nto costar&iacute;a a&ntilde;adir funciones a PHPlist <a href="mailto:mailtics@tincan.co.uk?subject=request for quote to change PHPlist">preg&uacute;ntenos</a>.
...
href="mailto:mailtics-stats@tincan.co.uk">mailtics-stats@tincan.co.uk</a>,
...
Para informar de un error vaya a <a href="http://mantis.tincan.co.uk/" target="_blank">http://mantis.tincan.co.uk</a>
