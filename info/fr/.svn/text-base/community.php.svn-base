...
if ($fp = @fopen ("http://www.mailtics.com/files/LATESTVERSION","r")) {
  ...
  if (versionCompare($thisversion,$latestversion)) {
    ...
    print '<a href="http://www.mailtics.com/files/changelog">Pour voir ce qui a chang&eacute;</a>&nbsp;&nbsp;';
    print '<a href="http://www.mailtics.com/files/mailtics-'.$latestversion.'.tgz">T&eacute;l&eacute;charger</a>';
  }
} else {
  print "<br/>T&eacute;l&eacute;charger la derni&egrave;re version de PHPlist: <a href=http://www.mailtics.com/files>ici</a>";
}
?>
...
<ul>
<li>Les <a href="http://www.mailtics.com/forums/" target="_blank">Forums de discussion</a></li>
...
Merci de mettre en ligne le r&eacute;sultat de vos exp&eacute;rimentations sur les <a href="http://www.mailtics.com/forums/" target="_blank">Forums</a>.</p></li>
<li>
<p>Vous pouvez utiliser PHPlist pour vos clients commerciaux (si votre entreprise est sur internet) et les convaincre que ce syst&egrave;me est un bon outil de travail.  Et si vos clients veulent quelques changements, vous pouvez <b>demander la cr&eacute;ation de nouvelles fonctionnalit&eacute;s</b> que vous pouvez facturer &agrave; vos clients. Pour savoir combien cela co&ucirc;te d&rsquo;ajouter des fonctionnalit&eacute;s &agrave; PHPlist, <a href="mailto:mailtics@tincan.co.uk?subject=request for quote to change PHPlist">contactez-nous</a>.
...
<li><p>Si vous utilisez PHPlist r&eacute;guli&egrave;rement, et que vous avez <b>un assez grand nombre d&rsquo;utilisateurs</b> (1000+), nous aimerions conna&icirc;tre vos sp&eacute;cifications techniques, et les statistiques sur les envois (send-statistics).  Par defaut, PHPlist  enverra des statistiques &agrave; <a href="mailto:mailtics-stats@tincan.co.uk">mailtics-stats@tincan.co.uk</a>, mais le logiciel n&rsquo;enverra aucun d&eacute;tail sur votre syst&egrave;me. Si vous voulez nous aider &agrave; am&eacute;liorer le logiciel, &ccedil;a serait vraiment bien de nous envoyer les sp&eacute;cifications de votre syst&egrave;me, et autoriser l&rsquo;envoi des statistiques &agrave; l&rsquo;adresse ci-dessus.
