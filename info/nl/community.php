...
<li>The <a href="http://www.mailtics.com/forums/" target="_blank">Forums</a>. The forums are the place to post your questions and for others to answer them.<br/><br/></li>
...
<input type="hidden" name="item_name" value="mailtics version <?php echo VERSIE?> for <?php echo $_SERVER['HTTP_HOST']?>">
...
<p>Als je een <b>regelmatige gebruiker bent van PHPlist</b> en je denkt dat je de meeste issues hebt gekraakt, dan kan je helpen door
 <a href="http://www.mailtics.com/forums/" target="_blank">Vragen van andere gebruikers te beantwoorden</a>. or writing pages in the <a href="#docscontrib">documentation site</a>.</p>
...
Please post your findings on the <a href="http://www.mailtics.com/forums/" target="_blank">Forums</a>.</p></li>
<li>
...
how much it would be to add features to PHPlist, <a href="mailto:mailtics2@tincan.co.uk?subject=request for quote to change PHPlist">get in touch</a>.
