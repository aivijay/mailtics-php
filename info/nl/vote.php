...
<p><b>Stem voor PHPlist</b><br/>
Als je denkt dat PHPlist geweldig is, en je wilt anderen adviseren om het te gebruiken, waarom geef je jou stem dan niet op enkele sites:
</p>
<p>Als je PHPlist op een andere site hebt gevonden, en je denkt dat die site hier zou moeten worden ingesloten, <a href="mailto:mailtics2@tincan.co.uk?subject=New Directory">zend ons snel een email</a></p>
<ul>
<li><b>Bij freshmeat</b>
...
<TR bgcolor=gray>
<TD colspan="3" style="color:#FFFFFF"><strong>Beoordeel dit product op Code Transit</strong></TD>
</TR>
<TR>
...
<li><b>Bij resourceindex</b><br/>
<a href="http://php.resourceindex.com/detail/00074.html" target="_vote">Beoordeel PHPlist</a><br/><br/>
</li>
<li><b>Bij <a href="http://www.hotscripts.com/?RID=9619">Hotscripts</a></b><br/>
...
<option value="1">Slecht</option></select></td><td>
<input type="submit" value="Rate It!"></td></tr></table></form>
<a href="http://www.hotscripts.com/review/?linkid=5015&returnto=http://www.hotscripts.com/Detailed/5015.html" target="_review">Schrijf een Review</a><br/><br/>

</li>
<li><b>Bij Devscripts.com</b>
...
<input type="hidden" name="strScriptId" value="1465">
    <select name="strRValue" onChange="document.frmRate.submit();">
        <option value="NULL">Beoordeel</option>
        <option value="10" selected>10</option>
...
<a href="http://devscripts.com/review.php?sId=1465" target="_review">Schrijf review</a><br/><br/>
</li>
<li><b>Bij webscript.ru</b> (russisch)<br/>
...
<li><b>Bij PHPindex.com</b> (frans)<br/>
...
<li><b>Bij bigboys</b><br/>
<form method="GET" action="http://www.big-boys.com/php/vote1.asp">
    <select size="1" name="F1">
      <option VALUE="1">1 - Slecht
      <option VALUE="2">2
      <option VALUE="3">3
      <option VALUE="4">4
      <option VALUE="5">5 - Gemiddeld
      <option VALUE="6">6
      <option VALUE="7">7
      <option VALUE="8">8
      <option VALUE="9">9
      <option VALUE="10" selected>10 - Geweldig
