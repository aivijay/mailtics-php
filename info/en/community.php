...
if ($fp = @fopen ("http://www.mailtics.com/files/LATESTVERSION","r")) {
  ...
  if (versionCompare($thisversion,$latestversion)) {
    ...
    print '<a href="http://www.mailtics.com/files/changelog">View what has changed</a>&nbsp;&nbsp;';
    print '<a href="http://www.mailtics.com/files/mailtics-'.$latestversion.'.tgz">Download</a>';
  }
} else {
  print "<br/>Check for the latest version: <a href=http://www.mailtics.com/files>here</a>";
}
?>
<p><i>mailtics</i> started early 2000 as a small application for the
...
<p>To facilitate the mailtics community several options are available:
<ul>
<li>The <a href="http://docs.mailtics.com" target="_blank">The Documentation Wiki</a>. The documentation site is mostly for reference, and no questions should be posted to it.<br/><br/></li>
<li>The <a href="http://forums.mailtics.com/" target="_blank">Forums</a>. The forums are the place to post your questions and for others to answer them.<br/><br/></li>
...
<input type="hidden" name="business" value="donate@mailtics.com">
<input type="hidden" name="item_name" value="mailtics version <?php echo VERSION?> for <?php echo $_SERVER['HTTP_HOST']?>">
...
<p>If you are a <b>regular user of mailtics</b> and you think you have cracked most of it's issues
you can help out by <a href="http://forums.mailtics.com/" target="_blank">answering the questions of other users</a>. or writing pages in the <a href="#docscontrib">documentation site</a>.</p>
<p>If you are <b>new to mailtics</b> and you are having problems with setting it up to work for
...
to the environment your mailtics installation is running in. Only having one developer for
mailtics has the disadvantage that the system cannot be tested thoroughly on every platform
and every version of PHP.</p>
<h1>Other things you can do to help</h1>
<ul>
<li><p>If you think mailtics is a great help for you, why not help to let other people know about
...
<p>To do so, you can <?php echo PageLink2("vote","Vote")?> for mailtics, or write reviews on the
sites that list applications. You can also tell other people you know about it.
</li>
<li><p>You can <b>Translate</b> mailtics into your language and submit the translation.
To help out check the <a href="http://docs.mailtics.com/PhplistTranslation">Translation Pages</a> in the Wiki.
</p>
</li>
<li>
<p>You can <b>Try out</b> all the different features of mailtics and check whether they work ok for you.
Please post your findings on the <a href="http://forums.mailtics.com/" target="_blank">Forums</a>.</p></li>
<li>
<p>You can use mailtics for your paying clients (if you are a web-outfit for example) and convince them
...
how much it would be to add features to mailtics, <a href="mailto:mailtics2@tincan.co.uk?subject=request for quote to change mailtics">get in touch</a>.
Most of the new features of mailtics are added by request from paying clients. This will benefit
you for paying a small price to achieve your aims, it will benefit the community for getting new
features, and it will benefit the developers for getting paid for some of the work on mailtics :-)</p></li>
<li><p>If you use mailtics regularly and you have a <b>fairly large amount of subscribers</b> (1000+), we are
interested in your system specification, and send-statistics. By default mailtics will send
statistics to <a href="mailto:mailtics-stats@tincan.co.uk">mailtics-stats@tincan.co.uk</a>, but it will
...
how well mailtics is performing.</p></li>
</ul>

</p>
<p><b><a name="bugtrack"></a>Mantis</b><br/>
<a href="http://mantis.mailtics.com/" target="_blank">Mantis</a> is the place to report issues you find with mailtics. Your issue can be be anything related to mailtics, comments and suggestions how to improve it or reports of a bug. If you report a bug, make sure to include as much information as possible to facilitate the developers in solving the problem.</p>
